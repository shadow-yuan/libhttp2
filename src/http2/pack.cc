...
typedef slice_buffer (*pack_func)(http2_frame *, uint32_t);
pack_func pack_funcs[] = {on_pack_frame_data,        on_pack_frame_headers,  on_pack_frame_priority,
                          on_pack_frame_rst_stream,  on_pack_frame_settings, on_pack_frame_push_promise,
